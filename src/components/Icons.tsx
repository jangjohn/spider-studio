/** Monochrome SVG icons — use currentColor to inherit text color (#9E9BB5 default, #7C6FF7 active) */

export function IconFolder({ className = "w-6 h-6" }: { className?: string }) {
  return (
...
export function IconExport({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export function IconFolderLarge({ className = "w-16 h-16" }: { className?: string }) {
  return (
...
export function IconTable({ className = "w-16 h-16" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
...
export function IconBrowser({ className = "w-12 h-12" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
